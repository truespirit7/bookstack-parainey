...
* Подразделы, Разделы, Chapters & Pages
* обновленный entitзаменой "полки" на "разделы" и "книги" на "подразделы"
*/
return [
// Shared
...
'recently_created_books' => 'Недавно созданные подразделы',
...
'import_desc' => 'Import подразделы, chapters & pages using a portable zip export from the same, or a different, instance. Select a ZIP file to proceed. After the file has been uploaded and validated you\'ll be able to configure & confirm the import in the next view.',
...
'permissions_book_cascade' => 'Права доступа, установленные для подразделов, автоматически распространяются на дочерние главы и страницы, если для них не определены собственные разрешения.',
...
'shelf' => 'Раздел',
'shelves' => 'Разделы',
'x_shelves' => ':count раздел|:count раздела|:count разделов',
...
'shelves_new_empty' => 'Последние созданные разделы появятся здесь.',
'shelves_save' => 'Сохранить раздел',
'shelves_books' => 'Подразделы из этого раздела',
'shelves_add_books' => 'Добавить подраздел в этот раздел',
'shelves_drag_books' => 'Перетащите подразделы ниже, чтобы добавить их в этот раздел',
'shelves_empty_contents' => 'В этом разделе нет подразделов',
'shelves_edit_and_assign' => 'Изменить раздел для привязки подразделов',
...
'shelves_delete_explain' => "Это приведет к удалению раздела с именем ':name'. Привязанные подразделы удалены не будут.",
'shelves_delete_confirmation' => 'Вы уверены, что хотите удалить этот раздел?',
...
'shelves_permissions_cascade_warning' => 'Разрешения на разделы не наследуются автоматически содержащимся в них подразделам. Это происходит потому, что подраздел может находиться в нескольких разделах. Однако разрешения могут быть установлены для подразделов раздела с помощью опции, приведенной ниже.',
'shelves_permissions_create' => 'Разрешения раздела на создание используется только для копирования разрешений на дочерние подразделы с помощью действия, описанного ниже. Они не контролируют возможность создавать подразделы.',
'shelves_copy_permissions_to_books' => 'Наследовать доступы подразделам',
'shelves_copy_permissions' => 'Копировать доступы',
'shelves_copy_permissions_explain' => 'Это применит текущие настройки разрешений для этого раздела ко всем подразделам, содержащимся в нем. Перед активацией убедитесь, что все изменения разрешений этого раздела были сохранены.',
'shelves_copy_permission_success' => 'Доступы раздела скопированы для :count подразделов',
// Books
'book' => 'Подраздел',
'books' => 'Подразделы',
'x_books' => ':count подраздел|:count подраздела|:count подразделов',
'books_empty' => 'Нет созданных подразделов',
'books_popular' => 'Популярные подразделы',
'books_recent' => 'Недавние подразделы',
'books_new' => 'Новые подразделы',
'books_new_action' => 'Новый подраздел',
'books_popular_empty' => 'Здесь появятся самые популярные подразделы.',
'books_new_empty' => 'Здесь появятся самые последние созданные подразделы.',
'books_create' => 'Создать новый подраздел',
'books_delete' => 'Удалить подраздел',
'books_delete_named' => 'Удалить подраздел :bookName',
'books_delete_explain' => 'Это удалит подразделы с именем \':bookName\'. Все разделы и страницы будут удалены.',
'books_delete_confirmation' => 'Вы действительно хотите удалить этот подраздел?',
'books_edit' => 'Редактировать подраздел',
'books_edit_named' => 'Редактировать подраздел :bookName',
'books_form_book_name' => 'Название подраздела',
'books_save' => 'Сохранить подраздел',
'books_permissions' => 'Разрешения на подраздел',
'books_permissions_updated' => 'Разрешения на подраздел обновлены',
'books_empty_contents' => 'Для этого подраздела нет страниц или разделов.',
'books_empty_create_page' => 'Создать новую страницу',
'books_empty_sort_current_book' => 'Сортировка текущего подраздела',
'books_empty_add_chapter' => 'Добавить главу',
'books_permissions_active' => 'Действующие разрешения подраздела',
'books_search_this' => 'Поиск в этом подразделе',
'books_navigation' => 'Навигация по подразделу',
'books_sort' => 'Сортировка содержимого подраздела',
'books_sort_desc' => 'Переместите разделы и страницы в подразделе, чтобы изменить содержание. Могут быть добавлены другие подразделы, что позволяет легко перемещать разделы и страницы между подразделами.',
'books_sort_named' => 'Сортировка подраздела :bookName',
...
'books_sort_show_other' => 'Показать другие подразделы',
'books_sort_save' => 'Сохранить новый порядок',
'books_sort_show_other_desc' => 'Добавьте другие подразделы здесь, чтобы включить их в сортировку, и позволить легко реорганизовать подраздел.',
'books_sort_move_up' => 'Переместить вверх',
'books_sort_move_down' => 'Переместить вниз',
'books_sort_move_prev_book' => 'Переместить в предыдущий подраздел',
'books_sort_move_next_book' => 'Переместить в следующий подраздел',
'books_sort_move_prev_chapter' => 'Переместить в предыдущую главу',
'books_sort_move_next_chapter' => 'Переместить в следующую главу',
'books_sort_move_book_start' => 'Переместить в начало подраздела',
'books_sort_move_book_end' => 'Переместить в конец подраздела',
'books_sort_move_before_chapter' => 'Переместить перед главой',
'books_sort_move_after_chapter' => 'Переместить после главы',
'books_copy' => 'Копировать подраздел',
'books_copy_success' => 'Подраздел успешно скопирован',
// Chapters
'chapter' => 'Глава',
'chapters' => 'Главы',
...
'chapter_sort_book' => 'Сортировать подраздел',
// Pages
'page' => 'Страница',
'pages' => 'Страницы',
...
'pages_delete_warning_template' => 'Эта страница активно используется как шаблон страницы по умолчанию для подраздела или главы. Эти подразделы или главы больше не будут иметь шаблон страницы по умолчанию, назначенный после удаления этой страницы.',
...
'tags_assigned_books' => 'Назначено на подразделы',
...
'tags_list_empty_hint' => 'Теги можно присваивать через боковую панель редактора страниц или при редактировании сведений о подразделе, главе или разделе.',
...
'profile_not_created_books' => ':userName не создал ни одного подраздела',
...
'convert_to_shelf_contents_desc' => 'Вы можете превратить этот подраздел в новый раздел с тем же содержимым. Главы, содержащиеся в этом подразделе, будут преобразованы в новые подразделы. Если этот подраздел содержит какие-либо страницы, которых нет в главе, она будет переименована и будет содержать такие страницы, и этот подраздел станет частью нового раздела.',
'convert_to_shelf_permissions_desc' => 'Любые разрешения, установленные для этого подраздела, будут скопированы на новый раздел и во все новые дочерние подразделы, для которых не применяются собственные разрешения. Обратите внимание, что разрешения на разделы не применяются автоматически к содержимому внутри, как это происходит с подразделами.',
'convert_book' => 'Преобразовать подраздел',
'convert_book_confirm' => 'Вы уверены, что хотите преобразовать этот подраздел?',
'convert_undo_warning' => 'Это не отменяется простым способом.',
'convert_to_book' => 'Преобразовать в подраздел',
'convert_to_book_desc' => 'Вы можете преобразовать эту главу в новый подраздел с тем же содержанием. Любые разрешения, установленные в этой главе, будут скопированы в новый подраздел, но любые унаследованные разрешения из родительского подраздела не будут скопированы, что может привести к изменению контроля доступа.',
...
'watch_detail_parent_book' => 'Просмотр через родительский подраздел',
'watch_detail_parent_book_ignore' => 'Игнорирование через родительский подраздел',
